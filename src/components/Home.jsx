    ...
    <div className='px-4'>
      ...
      <div className='px-4 bg-beast'>
        <div className='flex flex-col md:flex-row bg-beast'>
          <div className='md:w-1/2 py-8 md:py-28 mt-16'>
            <p className='text-4xl font-bold'>FIND MOVIES</p>
            <p className='text-5xl font-sans font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-800 to-pink-600'>TV SHOWS AND MORE</p>
          ...
          <div className='md:w-1/2 relative ml-0 md:ml-32 md:pr-8 -z-10'>
            <img src={im2} alt='im2' className="absolute w-[20rem] h-[450px] top-0 mt-6 ml-[10rem]" />
