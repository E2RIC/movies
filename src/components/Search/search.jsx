    ...
    <div className="container mx-auto p-4">
      <form onSubmit={handleSubmit} className="mb-4">
        <input
          ...
          className="w-full px-3 py-2 text-black placeholder-gray-400 border rounded-md focus:outline-none focus:placeholder-gray-600"
          placeholder="Search for movies..."
        />
        <button type="submit" className="bg-blue-500 text-white px-4 py-2 rounded-md mt-2">Search</button>
      </form>
